...
5. **Klantvragen fysio-toestemming uitzetten bij Berry** `(lokaal)` — nog open: **intrekprocedure** (bij wie melden, wat gebeurt er met gegevens die al bij SMC liggen, wat betekent intrekken voor de rest van het seizoen) en **of SMC een eigen privacyverklaring heeft om naartoe te linken**. Zolang dit niet beantwoord is staat er niets over intrekken op de infopagina. Documentinhoud ✓, pop-uptekst ✓ en gegevensdeling ✓ zijn beantwoord met de toestemmingsverklaring van 2026-08-04
6. **Adres van SMC Dijk en Waard verifiëren** `(lokaal)` — de verklaring vermeldt "Helena Nordheimland 3, 1705 LM Heerhugowaard"; die straatnaam ziet er uit als een typo (Nordheimlaan?). Staat nu letterlijk zo op de infopagina — checken bij Berry/SMC voor publicatie, een fout adres op een live pagina is vervelend
